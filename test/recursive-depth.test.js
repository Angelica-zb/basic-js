...
describe('Recursive depth', () => {
    ...
    describe('functional requirements', () => {
        ...
        it.optional('returns correct depth of nested arrays', () => {
            assert.equal(calculateDepth([1, [8, [
                    []
                ]],
                [
                    [
